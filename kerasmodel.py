from keras.layers import Conv2D, Dense, concatenate, merge, MaxPooling2D, Activation, AveragePooling2D, Concatenate, BatchNormalization, Input
from keras.models import Sequential, Model
import numpy as np

def build_model():
    input = Input(shape=(112,112,3))
    conv1 = (Conv2D(64, (7, 7), strides=2, name='conv1', activation='relu'))(input)
    pool1 = (MaxPooling2D((3,3), strides=2, name='pool1'))(conv1)
    norm1 = (BatchNormalization(name='norm1'))(pool1)
    reduction2 = (Conv2D(64, (1, 1), strides=1, name='reduction2', activation='relu'))(norm1)
    conv2 = (Conv2D(192, (3, 3), strides=1, name='conv2', activation='relu'))(reduction2)
    ...
    icp1_out2 = Conv2D(32, (5, 5), strides=(1,1), name='icp1_out2',activation='relu')(icp1_reduction2)
    ...
    icp1_out0 = Conv2D(64, (1, 1),  name='icp1_out0', activation='relu')(pool2)
    #
    #
    # # inception block2
    ...
    # icp3_reduction1 = Conv2D(112, (1,1), strides=1, name='icp3_reduction1',activation='relu')(icp3_in)
    # icp3_out1 = Conv2D(224, (3,3), strides=1, name='icp3_out1', activation='relu')(icp3_reduction1)
    #
    # icp3_reduction2 = Conv2D(24, (1,1), strides=1, name='icp3_reduction2', activation='relu')(icp3_in)
    # icp3_out2 = Conv2D(64, (5,5), strides=1, name='icp3_out2', activation='relu')(icp3_reduction2)
    #
    # icp3_pool = MaxPooling2D((3,3), strides=1, name='icp3_pool')(icp3_in)
    # icp3_out3 = Conv2D(64, (1,1), strides=1, name='icp3_out3', activation='relu')(icp3_pool)
    #
    # icp3_out0 = Conv2D(160, (1,1), strides=1, name='icp3_out0', activation='relu')(icp3_in)
    #
    #
    # # inception block4
    ...
    # icp4_out1 = Conv2D(320, (3,3), strides=1, name='icp3_out1', activation='relu')(icp4_reduction1)
    #
    ...
    model1.summary()
    model2 = Model(input=input, outputs=icp1_out2)
    model2.summary()
